...
class Phpfox_Cache_Storage_File extends Phpfox_Cache_Abstract
{
    ...
    public function set($sName, $sGroup = '')
    {
        ...
        //avoid conflict cache when rebuild theme
//        if (defined('PHPFOX_FORCE_FLAVOR_NAME') && PHPFOX_FORCE_FLAVOR_NAME) {
//            $sName = PHPFOX_FORCE_FLAVOR_NAME . '_' . $sName;
//        }
        $sId = $sName;
    ...
    public function save($sId, $mContent)
    {
        ...
        if (!is_writable($tmp)) {
            $tmp = PHPFOX_DIR_CACHE . DIRECTORY_SEPARATOR . 'phpfox_' . uniqid('');
        }
