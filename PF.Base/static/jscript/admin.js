...
$Behavior.tableHover = function()
{
    ...
    $('#table_hover_action_holder').
      html('<div class="selected-count" style="display:none;"><span class="count-number">0</span> ' + oTranslations['items_selected'] + ' <span class="deselect-all">' + oTranslations['deselect_all'] + '</span></div><div>' + $('.table_hover_action').html() + '</div>');
