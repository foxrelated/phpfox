        ...
        {foreach from=$aUsers key=iKey item=aUser}
            <tr class="checkRow{if is_int($iKey/2)} tr{else}{/if}">
                ...
                <td class="text-center">
                    <a href="#" title="{_p var='view_attempt'}: {$aUser.attempt}" onclick="tb_show('{_p var='admincp_login_log' phpfox_squote=true}', $.ajaxBox('core.admincp.viewAdminLogin', 'height=410&amp;width=550&amp;login_id={$aUser.login_id}')); return false;">
                    {if $aUser.is_failed}
