        ...
        <div class="panel-footer">
            ...
            <div class="form-group">
                ...
                <div class="item_is_active_holder">
                    <span class="js_item_active item_is_active"><input type="radio" name="overwrite" value="1" /></span>
                    <span class="js_item_active item_is_not_active"><input type="radio" name="overwrite" value="0" checked="checked" /></span>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="item_is_active_holder">
                    <span class="js_item_active item_is_active">
                        <input type="radio" name="val[utf_encoding]" value="1" id="utf_encoding"/>
                    </span>
                    <span class="js_item_active item_is_not_active">
                        <input type="radio" name="val[utf_encoding]" value="0" checked="checked" id="utf_encoding"/>
                    </span>
                </div>
            </div>
            <div class="form-group">
