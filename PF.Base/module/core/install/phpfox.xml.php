<module>
	...
	<settings>
        <!-- Below setting will be removed in 4.7.0 -->
		<setting group="server_settings" module_id="core" is_hidden="1" type="boolean" var_name="use_gzip" phrase_var_name="setting_use_gzip" ordering="3" version_id="2.0.0alpha1">1</setting>
        ...
        <!-- below setting will be removed in 4.7 -->
		<setting group="time_stamps" module_id="core" is_hidden="1" type="string" var_name="profile_time_stamps" phrase_var_name="setting_profile_time_stamps" ordering="8" version_id="2.0.0alpha1">F j, Y</setting>
		...
		<setting group="server_settings" module_id="core" is_hidden="1" type="drop" var_name="csrf_protection_level" phrase_var_name="setting_csrf_protection_level" ordering="4" version_id="2.0.0alpha1"><![CDATA[a:2:{s:7:"default";s:6:"medium";s:6:"values";a:3:{i:0;s:6:"medium";i:1;s:4:"high";i:2;s:3:"low";}}]]></setting>
        <!-- Below setting will be removed in 4.7.0 -->
		<setting group="server_settings" module_id="core" is_hidden="1" type="boolean" var_name="build_file_dir" phrase_var_name="setting_build_file_dir" ordering="5" version_id="2.0.0alpha1">1</setting>
        <!-- Below setting will be removed in 4.7.0 -->
		<setting group="server_settings" module_id="core" is_hidden="1" type="string" var_name="build_format" phrase_var_name="setting_build_format" ordering="6" version_id="2.0.0alpha1">Y/m</setting>
...
Site Name</setting>
        ...
        <!-- Below setting will be removed in 4.7.0 -->
		<setting group="server_settings" module_id="core" is_hidden="1" type="boolean" var_name="log_site_activity" phrase_var_name="setting_log_site_activity" ordering="7" version_id="2.0.0alpha1">0</setting>
        <!-- Below setting will be removed in 4.7.0 -->
		<setting group="server_settings" module_id="core" is_hidden="1" type="boolean" var_name="cache_js_css" phrase_var_name="setting_cache_js_css" ordering="8" version_id="2.0.0alpha1">0</setting>
        ...
        <!-- below setting will be removed in 4.7 -->
		<setting group="" module_id="core" is_hidden="1" type="drop" var_name="watermark_option" phrase_var_name="setting_watermark_option" ordering="1" version_id="2.0.0rc1"><![CDATA[a:2:{s:7:"default";s:4:"none";s:6:"values";a:3:{i:0;s:4:"none";i:1;s:5:"image";i:2;s:4:"text";}}]]></setting>
        <!-- below setting will be removed in 4.7 -->
		<setting group="" module_id="core" is_hidden="1" type="integer" var_name="watermark_opacity" phrase_var_name="setting_watermark_opacity" ordering="3" version_id="2.0.0rc1">100</setting>
        <!-- below setting will be removed in 4.7 -->
		<setting group="" module_id="core" is_hidden="1" type="drop" var_name="watermark_image_position" phrase_var_name="setting_watermark_image_position" ordering="4" version_id="2.0.0rc1"><![CDATA[a:2:{s:7:"default";s:12:"bottom_right";s:6:"values";a:4:{i:0;s:12:"bottom_right";i:1;s:11:"bottom_left";i:2;s:8:"top_left";i:3;s:9:"top_right";}}]]></setting>
        <!-- below setting will be removed in 4.7 -->
		<setting group="" module_id="core" is_hidden="1" type="string" var_name="image_text" phrase_var_name="setting_image_text" ordering="6" version_id="2.0.0rc1">www.yoursite.com</setting>
        ...
        <!-- Below setting will be removed in 4.7.0 -->
		<setting group="" module_id="core" is_hidden="1" type="boolean" var_name="can_move_on_a_y_and_x_axis" phrase_var_name="setting_can_move_on_a_y_and_x_axis" ordering="1" version_id="2.0.0rc4">0</setting>
  ...
  1 => '2|core.her|profile.female|core.herself|female',
        ...
        <!-- Below setting will be removed in 4.7.0 -->
		<setting group="server_settings" module_id="core" is_hidden="1" type="boolean" var_name="site_wide_ajax_browsing" phrase_var_name="setting_site_wide_ajax_browsing" ordering="1" version_id="2.1.0Beta1">0</setting>
        ...
        <!-- Below setting will be removed in 4.7.0 -->
		<setting group="server_settings" module_id="core" is_hidden="1" type="boolean" var_name="disable_hash_bang_support" phrase_var_name="setting_disable_hash_bang_support" ordering="14" version_id="3.0.0beta3">0</setting>
        ...
        <!-- below setting will be removed in 4.7 -->
		<setting group="" module_id="core" is_hidden="1" type="array" var_name="controllers_to_load_delayed" phrase_var_name="setting_controllers_to_load_delayed" ordering="4" version_id="3.6.0rc1"><![CDATA[s:8:"array();";]]></setting>
        <!-- below setting will be removed in 4.7 -->
		<setting group="" module_id="core" is_hidden="1" type="boolean" var_name="super_cache_system" phrase_var_name="setting_super_cache_system" ordering="5" version_id="3.6.0rc1">0</setting>
        <!-- below setting will be removed in 4.7 -->
		<setting group="" module_id="core" is_hidden="1" type="boolean" var_name="store_only_users_in_session" phrase_var_name="setting_store_only_users_in_session" ordering="6" version_id="3.6.0rc1">0</setting>
        ...
        <!-- Below setting will be removed in 4.7.0 -->
		<setting group="security" module_id="core" is_hidden="1" type="boolean" var_name="auth_user_via_session" phrase_var_name="setting_auth_user_via_session" ordering="5" version_id="3.6.0rc1">0</setting>
        ...
        <!-- below setting will be removed in 4.7 -->
		<setting group="" module_id="core" is_hidden="1" type="string" var_name="watermark_image" phrase_var_name="setting_watermark_image" ordering="2" version_id="2.0.0rc1">watermark%s.png</setting>
