<module>
	...
	<settings>
		...
		<setting group="" module_id="like" is_hidden="1" type="boolean" var_name="show_user_photos" phrase_var_name="setting_show_user_photos" ordering="1" version_id="3.3.0beta2">0</setting>
	</settings>
	<hooks>
