<module>
	...
	<settings>
		...
		<setting group="" module_id="feed" is_hidden="1" type="integer" var_name="total_likes_to_display" phrase_var_name="setting_total_likes_to_display" ordering="1" version_id="3.0.0Beta1">2</setting>
        ...
        <!-- Below setting will be removed in 4.7.0 -->
		<setting group="" module_id="feed" is_hidden="1" type="string" var_name="twitter_share_via" phrase_var_name="setting_twitter_share_via" ordering="1" version_id="3.0.0rc1">YourSite</setting>
        ...
        <!-- Below setting will be removed in 4.7.0 -->
		<setting group="" module_id="feed" is_hidden="1" type="boolean" var_name="cache_each_feed_entry" phrase_var_name="setting_cache_each_feed_entry" ordering="2" version_id="3.6.0rc1">0</setting>
        <!-- Below setting will be removed in 4.7.0 -->
