<module>
	...
	<settings>
		...
		<setting group="time_stamps" module_id="comment" is_hidden="1" type="string" var_name="comment_time_stamp" phrase_var_name="setting_comment_time_stamp" ordering="2" version_id="2.0.0alpha1">F j, Y</setting>
