...
class Api_Service_Gateway_Gateway extends Phpfox_Service 
{
     ...
     * @return bool|null
     */
	public function callback($sGateway, $iUserId = null)
	{
		...
		if($sGateway == 'activitypoints' && Phpfox::getParam('user.can_purchase_with_points') && Phpfox::getUserGroupParam($iUserGroupId, 'user.can_purchase_with_points'))
		{
