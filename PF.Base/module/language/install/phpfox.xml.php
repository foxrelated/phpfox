<module>
	...
	<settings>
		...
		<setting group="" module_id="language" is_hidden="1" type="boolean" var_name="auto_detect_language_on_ip" phrase_var_name="setting_auto_detect_language_on_ip" ordering="2" version_id="3.1.0beta1">0</setting>
        <!-- below setting will be removed in 4.7 -->
		<setting group="" module_id="language" is_hidden="1" type="boolean" var_name="no_string_restriction" phrase_var_name="setting_no_string_restriction" ordering="3" version_id="3.7.0beta2">0</setting>
	</settings>
	<hooks>
