    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            <div class="custom-radio-wrapper">
                <label><input name="val[rule]" type="radio" value="0" {if empty($aForms) ||( isset($aForms) && !$aForms.rule)}checked{/if}><span class="custom-radio"></span>{_p var='promotion_rule_or'}</label>
            </div>
            <div class="custom-radio-wrapper">
                <label><input name="val[rule]" type="radio" value="1" {if isset($aForms) && $aForms.rule}checked{/if}><span class="custom-radio"></span>{_p var='promotion_rule_and'}</label>
            </div>
        </div>
        <div class="form-group">
