            ...
            {elseif ($aItem.type_id == 'boolean' or $aItem.type_id =='input:radio')}
                <div class="item_is_active_holder">
                    <span class="js_item_active item_is_active hide">
                        <input type="radio" class="radio_yes" name="val[value_actual][{$aItem.setting_id}]" value="1" {if $aItem.value_actual == true || $aItem.value_actual == "1"}data-it="1yes" checked="checked" {/if}/>
                    </span>
                    <span class="js_item_active item_is_not_active hide">
                        <input type="radio" class="radio_no" name="val[value_actual][{$aItem.setting_id}]" value="0" {if !$aItem.value_actual}checked="checked" {/if}/>
                    </span>
                </div>
