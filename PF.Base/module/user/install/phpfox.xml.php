<module>
  ...
  1 => '2|core.her|profile.female|core.herself|female',
		...
		<setting group="" module_id="user" is_hidden="1" type="array" var_name="user_pic_sizes" phrase_var_name="setting_user_pic_sizes" ordering="1" version_id="2.0.0alpha1"><![CDATA[s:103:"array(
  0 => '20',
  1 => '50',
  2 => '60',
  3 => '75',
  ...
  6 => '200',
        ...
        <!-- Below setting will be removed in 4.7.0 -->
		<setting group="" module_id="user" is_hidden="1" type="integer" var_name="how_many_featured_members" phrase_var_name="setting_how_many_featured_members" ordering="1" version_id="2.0.0beta5">6</setting>
        ...
        <!-- Below setting will be removed in 4.7.0 -->
		<setting group="" module_id="user" is_hidden="1" type="integer" var_name="min_count_for_top_rating" phrase_var_name="setting_min_count_for_top_rating" ordering="1" version_id="2.0.0">0</setting>
        ...
        <!-- Below setting will be removed in 4.7.0 -->
		<setting group="" module_id="user" is_hidden="1" type="boolean" var_name="cache_featured_users" phrase_var_name="setting_cache_featured_users" ordering="1" version_id="3.6.0rc1">0</setting>
        <!-- Below setting will be removed in 4.7.0 -->
		<setting group="" module_id="user" is_hidden="1" type="boolean" var_name="cache_user_inner_joins" phrase_var_name="setting_cache_user_inner_joins" ordering="2" version_id="3.6.0rc1">0</setting>
