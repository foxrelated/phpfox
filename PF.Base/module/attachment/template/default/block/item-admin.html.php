...
<div id="content_attachment_{$aRow.attachment_id}" class="is-active content_attachment">
    ...
    <div id="remove-wrapper" class="icon-wrapper">
        <span onclick="tb_show('{_p var='Notice'}', $.ajaxBox('attachment.deleteAttachment', 'height=400&amp;width=550&amp;TB_inline=1&amp;call=attachment.deleteAttachment&amp;type=delete&amp;item_id={$aRow.attachment_id}'));" id="remove" title="{_p var='Remove from list'}" role="button">
