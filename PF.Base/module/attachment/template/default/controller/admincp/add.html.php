    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            <div class="item_is_active_holder">
                <span class="js_item_active item_is_active"><input type="radio" name="val[is_image]" value="1" {value type='radio' id='is_image' default='1'}/></span>
                <span class="js_item_active item_is_not_active"><input type="radio" name="val[is_image]" value="0" {value type='radio' id='is_image' default='0' selected='true'}/></span>
            </div>
        </div>
        <div class="form-group">
            <label for="is_active">{required}{_p var='active'}</label>
            <div class="item_is_active_holder">
                <span class="js_item_active item_is_active"><input type="radio" name="val[is_active]" value="1" {value type='radio' id='is_active' default='1' selected='true'}/></span>
                <span class="js_item_active item_is_not_active"><input type="radio" name="val[is_active]" value="0" {value type='radio' id='is_active' default='0'}/></span>
            </div>
        </div>
    </div>
