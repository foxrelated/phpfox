			...
			<div class="panel panel-default">
              <div class="panel-body">
                  <div class="form-group">
                      ...
                      <div class="p_4 custom-radio-wrapper" style="display:none;">
                          {_p var='phrase_from_language_package'}
                          <label>
                              <input type="radio" name="val[is_phrase]" id="is_phrase" value="1"{value type='radio' id='is_phrase' default='1'}/>
                              <span class="custom-radio"></span>
                              {_p var='yes'}
                          </label>
                          <label>
                              <input type="radio" name="val[is_phrase]" id="is_phrase" value="0"{value type='radio' id='is_phrase' default='0' selected=true}/>
                              <span class="custom-radio"></span>
                              {_p var='no'}
                          </label>
                      </div>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group" style="display:none;">
                        ...
                        <div class="custom-radio-wrapper">
                            <label>
                                <input type="radio" name="val[full_size]" value="1"{value type='radio' id='full_size' default='1' selected=true}/>
                                <span class="custom-radio"></span>
                                {_p var='yes'}
                            </label>
                        </div>
                        <div class="custom-radio-wrapper">
                            <label>
                                <input type="radio" name="val[full_size]" value="0"{value type='radio' id='full_size' default='0'}/>
                                <span class="custom-radio"></span>
                                {_p var='no'}
                            </label>
                    ...
                    <div class="form-group" style="display:none;">
                        ...
                        <div class="custom-radio-wrapper">
                            <label>
                                <input type="radio" name="val[has_bookmark]" value="1"{value type='radio' id='has_bookmark' default='1' selected=true}/>
                                <span class="custom-radio"></span>
                                {_p var='yes'}
                            </label>
                        </div>
                        <div class="custom-radio-wrapper">
                            <label>
                                <input type="radio" name="val[has_bookmark]" value="0"{value type='radio' id='has_bookmark' default='0'}/>
                                <span class="custom-radio"></span>
                                {_p var='no'}
                            </label>
                    ...
                    <div class="form-group" style="display:none;">
                        ...
                        <div class="custom-radio-wrapper">
                            <label>
                                <input type="radio" name="val[add_view]" value="1"{value type='radio' id='add_view' default='1'}/>
                                <span class="custom-radio"></span>
                                {_p var='yes'}
                            </label>
                        </div>
                        <div class="custom-radio-wrapper">
                            <label>
                                <input type="radio" name="val[add_view]" value="0"{value type='radio' id='add_view' default='0' selected=true}/>
                                <span class="custom-radio"></span>
                                {_p var='no'}
                            </label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-radio-wrapper">
                            <label>
                                <input type="radio" name="val[add_menu]" value="1"{value type='radio' id='add_menu' default='1' selected=true}/>
                                <span class="custom-radio"></span>
                                {_p var='yes'}
                            </label>
                        </div>
                        <div class="custom-radio-wrapper">
                            <label>
                                <input type="radio" name="val[add_menu]" value="0"{value type='radio' id='add_menu' default='0'}/>
                                <span class="custom-radio"></span>
                                {_p var='no'}
                            </label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-radio-wrapper">
                            <label>
                                <input type="radio" name="val[m_connection]" value="main"{value type='radio' id='m_connection' default='main' selected=true}/>
                                <span class="custom-radio"></span>
                                {_p var='main'}
                            </label>
                        </div>
                        <div class="custom-radio-wrapper">
                            <label>
                                <input type="radio" name="val[m_connection]" value="footer"{value type='radio' id='m_connection' default='footer'}/>
                                <span class="custom-radio"></span>
                                {_p var='footer'}
                            </label>
                        </div>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="p_4 custom-checkbox-wrapper">
                            <label>
                    ...
                    <div class="p_4 custom-checkbox-wrapper" style="display:none;">
                        Parser:
                        <label>
                            <input type="checkbox" name="val[parse_bbcode]" value="1" checked="checked" class="v_middle" />
                            <span class="custom-checkbox"></span>
                            {_p var='bbcode'}
                        </label>
                        <label>
                            <input type="checkbox" name="val[parse_breaks]" value="1" checked="checked" class="v_middle" />
                            <span class="custom-checkbox"></span>
                            {_p var='add_smart_breaks'}
                        </label>
                        <label>
                            <input type="checkbox" name="val[parse_php]" value="1" checked="checked" class="v_middle" />
                            <span class="custom-checkbox"></span>
                            {_p var='php'}
                        </label>
                    </div>
