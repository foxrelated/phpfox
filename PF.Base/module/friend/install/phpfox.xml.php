<module>
	...
	<settings>
		...
		<setting group="" module_id="friend" is_hidden="1" type="boolean" var_name="hide_denied_requests_from_pending_list" phrase_var_name="setting_hide_denied_requests_from_pending_list" ordering="1" version_id="2.0.7">1</setting>
		...
		<setting group="" module_id="friend" is_hidden="1" type="boolean" var_name="cache_is_friend" phrase_var_name="setting_cache_is_friend" ordering="4" version_id="3.6.0rc1">0</setting>
        <!-- below setting will be removed in 4.7 -->
		<setting group="" module_id="friend" is_hidden="1" type="boolean" var_name="cache_friend_list" phrase_var_name="setting_cache_friend_list" ordering="5" version_id="3.6.0rc1">0</setting>
        <!-- Below setting will be removed in 4.7.0 -->
		<setting group="" module_id="friend" is_hidden="1" type="boolean" var_name="load_friends_online_ajax" phrase_var_name="setting_load_friends_online_ajax" ordering="6" version_id="3.6.0rc1">0</setting>
