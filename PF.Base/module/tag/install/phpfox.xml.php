<module>
	...
	<settings>
		...
		<setting group="time_stamps" module_id="tag" is_hidden="1" type="string" var_name="trending_topics_timestamp" phrase_var_name="setting_trending_topics_timestamp" ordering="1" version_id="3.0.1">F j, Y</setting>
