<module>
	...
	<settings>
		...
		<setting group="" module_id="mail" is_hidden="1" type="boolean" var_name="enable_mail_box_warning" phrase_var_name="setting_enable_mail_box_warning" ordering="1" version_id="2.0.0beta5">1</setting>
        ...
        <!-- below setting will be removed in 4.7 -->
		<setting group="" module_id="mail" is_hidden="1" type="integer" var_name="cron_delete_messages_delay" phrase_var_name="setting_cron_delete_messages_delay" ordering="2" version_id="2.0.0beta5">30</setting>
		...
		<setting group="" module_id="mail" is_hidden="1" type="boolean" var_name="update_message_notification_preview" phrase_var_name="setting_update_message_notification_preview" ordering="1" version_id="3.1.0beta1">1</setting>
        <!-- Below setting will be removed in 4.7.0 -->
