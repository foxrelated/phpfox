...
class Share_Component_Block_Addthis extends Phpfox_Component
{
	...
	{
	    if (!Phpfox::getParam('share.show_addthis_section')) {
	        return false;
        }
	    $sPubId = $this->getParam('pubid', setting('share.addthis_pub_id', ''));
	    $sCustomize = ($sPubId != '') ? $this->getParam('customize', setting('share.addthis_share_button', '')) : '';
