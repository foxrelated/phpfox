        ...
        <div class="panel-footer">
            ...
            <div class="form-group">
                ...
                <div class="custom-radio-wrapper">
                    <label>
                        <input type="radio" name="val[is_active]" style="vertical-align:bottom;" value="1" {value type='radio' id='is_active' default='1' selected=true} />
                ...
                <div class="custom-radio-wrapper">
                    <label>
                        <input type="radio" name="val[is_active]" style="vertical-align:bottom;" value="0" {value type='radio' id='is_active' default='0'} />
                        <span class="custom-radio"></span>
                        {_p var='no'}
                    </label>
                </div>
