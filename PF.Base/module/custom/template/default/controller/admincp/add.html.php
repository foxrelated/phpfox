            ...
            <div class="panel-body">
                ...
                <div class="custom-radio-wrapper">
                    <label class="radio-inline">
                        <input type="radio" name="val[is_required]" value="1" class="v_middle checkbox" {value type='radio' id='is_required' default='1'}/>
                        <span class="custom-radio"></span>
                        {_p var='yes'}
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="val[is_required]" value="0" class="v_middle checkbox" {value type='radio' id='is_required' default='0' selected=true}/>
                        <span class="custom-radio"></span>
                        {_p var='no'}
                    </label>
                </div>
                ...
                <div class="custom-radio-wrapper">
                    <label class="radio-inline">
                        <input type="radio" name="val[on_signup]" value="1" class="v_middle checkbox" {value type='radio' id='on_signup' default='1'}/>
                        <span class="custom-radio"></span>
                        {_p var='yes'}
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="val[on_signup]" value="0" class="v_middle checkbox" {value type='radio' id='on_signup' default='0' selected=true}/>
                        <span class="custom-radio"></span>
                        {_p var='no'}
                    </label>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="custom-radio-wrapper">
                        <label class="radio-inline">
                            <input type="radio" name="val[is_search]" value="1" class="v_middle checkbox" {value type='radio' id='is_search' default='1' selected=true}/>
                            <span class="custom-radio"></span>
                            {_p var='yes'}
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="val[is_search]" value="0" class="v_middle checkbox" {value type='radio' id='is_search' default='0' }/>
                            <span class="custom-radio"></span>
                            {_p var='no'}
                        </label>
                    </div>
