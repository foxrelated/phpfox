...
class Custom_Service_Process extends Phpfox_Service
{
    ...
    public function update($iId, $aVals)
    {
        ...
        if ($aVals['user_group_id'] && Phpfox::getUserGroupParam($aVals['user_group_id'], 'custom.has_special_custom_fields')) {
            $aInsertDb['user_group_id'] = $aVals['user_group_id'];
        }

        $this->database()->update($this->_sTable, $aInsertDb, 'field_id = ' . (int)$iId);
