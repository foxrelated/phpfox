...
?>
<form class="form" method="post" action="{url link='admincp.subscribe.add'}" enctype="multipart/form-data" onsubmit="$Core.onSubmitForm(this, true);">
{if $bIsEdit}
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-group form-group-follow">
                ...
                <div class="item_is_active_holder">
                    <span class="js_item_active item_is_active"><input type="radio" id="is_recurring" name="val[is_recurring]" value="1" {value type='radio' id='is_recurring' default='1'}/></span>
                    <span class="js_item_active item_is_not_active"><input type="radio" id="is_recurring" name="val[is_recurring]" value="0" {value type='radio' id='is_recurring' default='0' selected='true'}/></span>
                </div>
            </div>
