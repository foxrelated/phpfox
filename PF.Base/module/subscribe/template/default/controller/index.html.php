                ...
                <div class="item membership-item">
                    <div class="item-outer">
                        ...
                        {if !empty($aPackage.description)}
                            ...
                            {/if}
                            {if Phpfox::isUser()}
                            <a class="btn btn-primary" href="#" onclick="tb_show('{_p var='select_payment_gateway' phpfox_squote=true}', $.ajaxBox('subscribe.upgrade', 'height=400&amp;width=400&amp;id={$aPackage.package_id}'));">{_p var='purchase'}</a>
                            {/if}
                    </div>
                </div>
            {/foreach}
