...
<form method="post" action="{url link='admincp.report'}" class="form">
        ...
        <table class="table table-admin">
            <thead>
                <tr>
                    ...
                    <th class="t_center">{_p var='total'}</th>
                    <th>{_p var='date'}</th>
            ...
            <tbody>
                ...
                <tr id="js_row{$aReport.data_id}">
                    ...
                    <td class="t_center"><a href="#" onclick="tb_show('{_p var='Reported by'}', $.ajaxBox('report.browse', 'height=400&amp;width=550&amp;data_id={$aReport.data_id}')); return false;">{$aReport.total_report}</a></td>
	...
	<div class="table_hover_action hidden">
		...
		<input type="submit" name="ignore" value="{_p var='ignore_selected'}" class="sJsConfirm delete btn btn-default sJsCheckBoxButton disabled" disabled="true" />
	</div>
	{else}
