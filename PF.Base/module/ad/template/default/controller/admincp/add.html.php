        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="checkbox">
                        <label class="radio-inline">
                            <input type="checkbox" name="val[view_unlimited]" id="view_unlimited" class="v_middle"{if (isset($aForms) && isset($aForms.view_unlimited)) || (!isset($aForms))} checked="checked" {/if}/>
                ...
                <div class="form-group" id="js_total_click" style="display:none;">
                    ...
                    <div class="checkbox">
                        <label class="radio-inline">
                            <input type="checkbox" name="val[click_unlimited]" id="click_unlimited" class="v_middle"{if (isset($aForms) && isset($aForms.click_unlimited)) || (!isset($aForms))} checked="checked" {/if}/>
                            <span class="custom-checkbox"></span>
                            {_p var='unlimited'}
                        </label>
                    </div>
            ...
            <div class="form-group">
                ...
                <div class="p_4" style="display:none;" id="js_user_group">
                    ...
                    <div class="p_4 checkbox">
                        <label>
                            <input type="checkbox" name="val[user_group][]" value="{$aUserGroup.user_group_id}"{if isset($aAccess) && is_array($aAccess)}{if in_array($aUserGroup.user_group_id, $aAccess)} checked="checked" {/if}{else} checked="checked" {/if}/>
                            <span class="custom-checkbox"></span>
