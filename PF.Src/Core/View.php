...
class View
{
    ...
    public function __construct()
    {
        ...
        $this->_env->addFunction(new \Twig_SimpleFunction('payment', function ($params) {
            $params = new \Core\Objects($params);
    ...
    public function getContent($force = false)
    {
        ...
        $params['menu_list'] = new View\Functions('menu_list');
        ...
        $params['notification'] = new View\Functions('notification'); // TODO check and remove this line
        ...
        $params['menu_nav'] = new View\Functions('menu_nav'); // TODO check and remove this line

        $params['main_class'] = (($Template->bIsSample) ? 'force' : '');

        $isPreviewLayout = \Phpfox_Request::instance()->get('get-block-layout', false);
        if (!$isPreviewLayout) {
